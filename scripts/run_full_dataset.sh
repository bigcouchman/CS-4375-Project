...
FULL_MAX_SAMPLES="${FULL_MAX_SAMPLES:-4800}"
FULL_MAX_TEST_SAMPLES="${FULL_MAX_TEST_SAMPLES:-1200}"
...
FULL_CLASSIFIER_LR="${FULL_CLASSIFIER_LR:-0.003}"
FULL_CLASSIFIER_WEIGHT_DECAY="${FULL_CLASSIFIER_WEIGHT_DECAY:-0.002}"
FULL_CLASSIFIER_HIDDEN_DIMS="${FULL_CLASSIFIER_HIDDEN_DIMS:-64,32}"
FULL_CLASSIFIER_DROPOUT="${FULL_CLASSIFIER_DROPOUT:-0.55}"
FULL_CLASSIFIER_FEATURE_NOISE_STD="${FULL_CLASSIFIER_FEATURE_NOISE_STD:-0.02}"
FULL_CLASSIFIER_EARLY_STOPPING_PATIENCE="${FULL_CLASSIFIER_EARLY_STOPPING_PATIENCE:-6}"
FULL_CLASSIFIER_EARLY_STOPPING_MIN_DELTA="${FULL_CLASSIFIER_EARLY_STOPPING_MIN_DELTA:-0.001}"
...
if [[ "$FULL_RUN_CLASSIFICATION" -eq 1 ]]; then
  args+=(
    ...
    --classifier-feature-noise-std "$FULL_CLASSIFIER_FEATURE_NOISE_STD"
        --classifier-early-stopping-patience "$FULL_CLASSIFIER_EARLY_STOPPING_PATIENCE"
        --classifier-early-stopping-min-delta "$FULL_CLASSIFIER_EARLY_STOPPING_MIN_DELTA"
    --save-predictions
